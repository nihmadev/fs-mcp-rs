...
use crate::protocol::{Request as McpRequest, Response as McpResponse, negotiate_protocol};
...
pub async fn handle_request(app: &App, request: McpRequest) -> Option<McpResponse> {
